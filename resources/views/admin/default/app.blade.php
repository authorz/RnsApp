<!-- navbar -->
<div data-ng-include=" '/admin/public/header' " class="app-header navbar">
</div>
<!-- / navbar -->

<!-- menu -->
<div data-ng-include=" '/admin/public/aside' " class="app-aside hidden-xs @{{app.settings.asideColor}}">
</div>
<!-- / menu -->
...
<div data-ng-include=" '/admin/public/settings' " class="settings panel panel-default">
</div>